...
<div id="container">
  <div id="mainContent">
	...
	Campaign Name:<br />
	<input type="text" maxlength="100" name="campaignName" value="Redington BYOB" /><br />
	...
	<textarea name="description" rows="5" cols="15">Lorem ipsum...</textarea><br />

	<input type="submit" name="edit" value="Edit" />&nbsp;&nbsp;<input type="reset" name="reset" value="Clear" />
