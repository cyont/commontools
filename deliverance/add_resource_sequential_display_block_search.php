...
<!--		<a href="#" title="Add a resource to this display block"><img src="/deliverance/images/plus_sign.gif" width="13" height="13" alt="Add a resource to this display block" id="plusSign" /></a>-->
	...
	?>
		...
		<div id="infoOptions">
			...
			<div><p style="padding-top:5px;">To see a listing of all resources compatible with this Display Block, click the "Search" button. Or customize your search by entering part of the resource name and/or its age. (<a href="add_resource_sequential_display_block.php?displayBlockID=<? echo $_GET['displayBlockID'] ?>">back</a>)</p>
			</div>
			<div>
			...
			?>
					...
					<div style="margin-bottom:20px;">
						...
						<input type="button" value="Select" onClick="window.location='add_resource_sequential_display_block.php?displayBlockID=<? echo $_GET['displayBlockID'] ?>&resourceID=<? echo $rowResList['id']; ?>'" />
					</div>
